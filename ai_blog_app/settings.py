...
# define a localização da diretoria onde gravar os ficheiros audio - no topo deste ficheiro está o import os
MEDIA_URL = '/media/'
...
# indica que em caso de não estar logado e tentar aceder à home page é redirecionado para a página de login
LOGIN_URL = 'login'
